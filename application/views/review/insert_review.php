					...
					<div class="span12"> <br/><hr/>
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane fade active in" id="home">
								...
								<!-- Review film =========================================================== -->
								<?php echo form_open('film/insertReview', "role='form'"); ?>
								<?php echo form_hidden('id',$id); ?>
								<div class="form-group">
				                	<label><strong>Rating</strong></label>
				                	<input type="number" class="form-control" placeholder="rating" id="rating" name="rating" min="1" max="10" required data-validation-required-message="Masukan Rating film"> /10
				                </div>
				                <div class="form-group">
				                	<label><strong>Review</strong></label>
				                	<textarea id="review" name="review" required data-validation-required-message="Masukan Review film" class="form-control" rows="10" style="width:90%"></textarea>
				                </div>
